...
//     日経平均に対して10年再現したもの
//   ・成績はすべて 1458（楽天ETF日経レバレッジ）の実際の市場価格。レバETFの日次リバランス
//     減価と信託報酬は価格に織り込み済み（理論2倍換算はしていない）。1570でなく1458なのは
//     検証39補足（同指数でコスト半分以下・全10局面で1570に勝ち）による
...
data class CrashEpisode(
    ...
    val bottomDate: String,     // 1458が最も安かった日
...
val CRASH_HISTORY: List<CrashEpisode> = listOf(
    ...
    CrashEpisode(
        ...
        bottomDate = "2016-11-09", bottomOffset = 54, bottomPct = -2.5,
        r5 = -2.3, r1m = -1.0, r3m = 20.9,
        r6m = 36.0, r12m = 38.3,
        maxDdA = -2.5, g12m = 12.8, maxDdG = -0.8,
    ...
    CrashEpisode(
        ...
        r5 = 5.7, r1m = 13.7, r3m = 18.7,
        r6m = 38.0, r12m = 47.7,
        maxDdA = 0.0, g12m = 15.9, maxDdG = 0.0,
    ...
    CrashEpisode(
        ...
        bottomDate = "2018-12-25", bottomOffset = 215, bottomPct = -19.0,
        r5 = 6.4, r1m = 4.8, r3m = 16.6,
        r6m = 9.8, r12m = 1.6,
        maxDdA = -19.0, g12m = 16.4, maxDdG = -6.3,
    ...
    CrashEpisode(
        ...
        bottomDate = "2018-12-25", bottomOffset = 1, bottomPct = -10.5,
        r5 = -6.6, r1m = 4.1, r3m = 14.4,
        r6m = 16.5, r12m = 42.7,
        maxDdA = -10.5, g12m = 32.8, maxDdG = -3.5,
    ...
    CrashEpisode(
        ...
        bottomDate = "2020-03-19", bottomOffset = 194, bottomPct = -34.7,
        r5 = 7.3, r1m = 13.8, r3m = 2.2,
        r6m = 32.1, r12m = 19.5,
        maxDdA = -34.7, g12m = 45.3, maxDdG = -20.5,
    ...
    CrashEpisode(
        ...
        bottomDate = "2020-03-19", bottomOffset = 148, bottomPct = -35.4,
        r5 = -1.2, r1m = 6.8, r3m = 33.5,
        r6m = 32.9, r12m = 22.5,
        maxDdA = -35.4, g12m = 50.1, maxDdG = -20.8,
    ...
    CrashEpisode(
        ...
        bottomDate = "2020-03-19", bottomOffset = 15, bottomPct = -44.1,
        r5 = -5.7, r1m = -25.9, r3m = 0.8,
        r6m = 8.3, r12m = 71.0,
        maxDdA = -44.1, g12m = 87.2, maxDdG = -38.8,
    ...
    CrashEpisode(
        ...
        bottomDate = "2022-03-09", bottomOffset = 8, bottomPct = -13.1,
        r5 = -3.7, r1m = 13.2, r3m = 8.0,
        r6m = 12.2, r12m = 15.5,
        maxDdA = -13.1, g12m = 5.2, maxDdG = -4.4,
    ...
    CrashEpisode(
        ...
        r5 = 13.0, r1m = 13.9, r3m = 32.0,
        r6m = 31.2, r12m = 55.6,
        maxDdA = -18.0, g12m = 18.5, maxDdG = -6.0,
    ...
    CrashEpisode(
        ...
        bottomDate = "2025-04-07", bottomOffset = 4, bottomPct = -23.9,
        r5 = -15.4, r1m = 2.0, r3m = 21.0,
        r6m = 61.3, r12m = 137.1,
        maxDdA = -23.9, g12m = 176.3, maxDdG = -8.7,
    ...
    CrashEpisode(
        ...
        bottomDate = "2026-03-31", bottomOffset = 14, bottomPct = -10.3,
        r5 = -2.0, r1m = 6.2, r3m = 45.6,
        r6m = null, r12m = null,
        maxDdA = -10.3, g12m = null, maxDdG = -3.4,
